        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonoId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Produtos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Produtos_AspNetUsers_DonoId",
                        column: x => x.DonoId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservas_AspNetUsers_ReceptorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produtos_Cidade_Status",
                table: "Produtos",
                columns: new[] { "Cidade", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Produtos_DonoId",
                table: "Produtos",
                column: "DonoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservas_ReceptorId",
                table: "Reservas",
                column: "ReceptorId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservas_Status_DataExpiracao",
                table: "Reservas",
                columns: new[] { "Status", "DataExpiracao" });
        }
